...
bool start_tests() {
    ...
    list.free_block_with_handle(h1.unwrap_copy());
    list.free_block_with_handle(h3.unwrap_copy());
    list.free_block_with_handle(h2.unwrap_copy());
    list.free_block_with_handle(h4.unwrap_copy());
